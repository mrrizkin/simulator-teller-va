const Loading = () => {
  return (
    <div className="relative flex justify-center items-center w-[56px] h-[56px]">
      <div>
        <div className="absolute flex items-center justify-center h-full w-full z-10 pointer-none top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <svg
            width="47"
            height="51"
            viewBox="0 0 47 51"
            ...
            className="glow transform scale-60"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <div
          id="globe"
          className="opacity-50 transform rotate-[30deg] scale-50 rounded-[100%] h-[104px] relative w-[104px] "
        >
          <svg
            width="104"
            height="104"
